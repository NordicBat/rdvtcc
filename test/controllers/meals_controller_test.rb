...
class MealsControllerTest < ActionController::TestCase
  ...
  test "should create meal" do
    assert_difference('Meal.count') do
      post :create, meal: { date: @meal.date, total: @meal.total, travel_id: @meal.travel_id, type: @meal.type }
    end
  ...
  test "should update meal" do
    patch :update, id: @meal, meal: { date: @meal.date, total: @meal.total, travel_id: @meal.travel_id, type: @meal.type }
    assert_redirected_to meal_path(assigns(:meal))
  end
