class TravelsController < ApplicationController
  ...
  def index
    #@travels = Travel.all
    @travels = Travel.page(params[:page]).per(10)
  end
  ...
  def travel_params
    params.require(:travel).permit(:city_id, :initialDate, :finalDate, :description, :vehicle_id, :meal_id, :fuel_id, :lodging_id, :tollBoth_id, :finalOdometer, :user_id)
  end
end
